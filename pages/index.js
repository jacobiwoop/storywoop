...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>StoryHub — Centralisez vos Storytimes</title>
        <meta
          name="description"
          content="La plateforme ultime pour les coachs et créateurs pour gérer les histoires de leur communauté."
        />
      </Head>
        ...
        <header className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <div className={styles.ctaGroup}>
              <button className={styles.btnPrimary}>Démarrer la Bêta</button>
